...
export const factoryAbi = [
  ...
  "function createBounty(string _repoOwner, string _repo, string _issueNumber)",
...
export const bountyAbi = [
  ...
  "function initialise(address _owner, string _repoOwner, string _repo, string _issueNumber)",
